...
class ByteIOContext(_rpythonic_struct_): pass
class AVMetadataTag(_rpythonic_struct_): pass
class AVMetadata(_rpythonic_struct_): pass
...
__freeze_rpythonic_struct( ByteIOContext, [
...
__freeze_rpythonic_struct( AVMetadataTag, [
	( "key", ctypes.POINTER(ctypes.c_char) ),
	( "value", ctypes.POINTER(ctypes.c_char) ),
])

__freeze_rpythonic_struct( AVMetadata, [
])
...
__freeze_rpythonic_struct( AVStream, [
	...
	( "unused", ( ctypes.c_int64 * 5 ) ),
	( "filename", ctypes.POINTER(ctypes.c_char) ),
	( "disposition", ctypes.c_int ),
	( "probe_data", AVProbeData ),
	( "pts_buffer", ( ctypes.c_int64 * 23 ) ),
	( "sample_aspect_ratio", AVRational ),
	( "metadata", ctypes.POINTER(AVMetadata) ),
...
__freeze_rpythonic_struct( AVProgram, [
	( "C_id", ctypes.c_int ),
	( "provider_name", ctypes.POINTER(ctypes.c_char) ),
	( "name", ctypes.POINTER(ctypes.c_char) ),
	( "flags", ctypes.c_int ),
	( "discard", ctypes.c_int ),
...
__freeze_rpythonic_struct( AVFormatContext, [
	...
	( "priv_data", ctypes.POINTER(ctypes.c_void_p) ),
	( "pb", ctypes.POINTER(ByteIOContext) ),
	( "nb_streams", ctypes.c_uint ),
	( "streams", ctypes.POINTER(( AVStream * 20 )) ),
	...
	( "cur_ptr_deprecated", ctypes.POINTER(ctypes.c_uint8) ),
	( "cur_len_deprecated", ctypes.c_int ),
	( "cur_pkt_deprecated", AVPacket ),
	( "data_offset", ctypes.c_int64 ),
	( "index_built", ctypes.c_int ),
...
url_set_interrupt_cb = _rpythonic_function_(		"url_set_interrupt_cb", ctypes.c_void_p, [
	("interrupt_cb",		ctypes.CFUNCTYPE(ctypes.c_int, )),] )
...
register_protocol = _rpythonic_function_(		"register_protocol", ctypes.c_int, [
	("protocol",		ctypes.POINTER(URLProtocol)),] )

av_register_protocol = _rpythonic_function_(		"av_register_protocol", ctypes.c_int, [
	("protocol",		ctypes.POINTER(URLProtocol)),] )
...
av_alloc_put_byte = _rpythonic_function_(		"av_alloc_put_byte", ctypes.POINTER(ByteIOContext), [
	("buffer",		ctypes.POINTER(ctypes.c_ubyte)),
	("buffer_size",		ctypes.c_int),
	("write_flag",		ctypes.c_int),
	("opaque",		ctypes.POINTER(ctypes.c_void_p)),
...
url_fskip = _rpythonic_function_(		"url_fskip", ctypes.c_void_p, [
	("s",		ctypes.POINTER(ByteIOContext)),
	("offset",		ctypes.c_int64),] )
...
av_url_read_fpause = _rpythonic_function_(		"av_url_read_fpause", ctypes.c_int, [
	("h",		ctypes.POINTER(ByteIOContext)),
	("pause",		ctypes.c_int),] )
...
ff_get_v = _rpythonic_function_(		"ff_get_v", ctypes.c_uint64, [
	("bc",		ctypes.POINTER(ByteIOContext)),] )

url_fdopen = _rpythonic_function_(		"url_fdopen", ctypes.c_int, [
	("s",		ctypes.POINTER(ctypes.POINTER(ByteIOContext))),
	("h",		ctypes.POINTER(URLContext)),] )
...
url_resetbuf = _rpythonic_function_(		"url_resetbuf", ctypes.c_int, [
	("s",		ctypes.POINTER(ByteIOContext)),
	("flags",		ctypes.c_int),] )

ff_rewind_with_probe_data = _rpythonic_function_(		"ff_rewind_with_probe_data", ctypes.c_int, [
	("s",		ctypes.POINTER(ByteIOContext)),
	("buf",		ctypes.POINTER(ctypes.c_ubyte)),
	("buf_size",		ctypes.c_int),] )
...
ff_crc04C11DB7_update = _rpythonic_function_(		"ff_crc04C11DB7_update", ctypes.c_ulong, [
	("checksum",		ctypes.c_ulong),
	("buf",		ctypes.POINTER(ctypes.c_uint8)),
	("C_len",		ctypes.c_uint),] )
...
udp_get_file_handle = _rpythonic_function_(		"udp_get_file_handle", ctypes.c_int, [
	("h",		ctypes.POINTER(URLContext)),] )

av_metadata_get = _rpythonic_function_(		"av_metadata_get", ctypes.POINTER(AVMetadataTag), [
	("m",		ctypes.POINTER(AVMetadata)),
	("key",		ctypes.POINTER(ctypes.c_char)),
	("prev",		ctypes.POINTER(AVMetadataTag)),
	("flags",		ctypes.c_int),] )

av_metadata_set = _rpythonic_function_(		"av_metadata_set", ctypes.c_int, [
	("pm",		ctypes.POINTER(ctypes.POINTER(AVMetadata))),
	("key",		ctypes.POINTER(ctypes.c_char)),
	("value",		ctypes.POINTER(ctypes.c_char)),] )
...
av_metadata_free = _rpythonic_function_(		"av_metadata_free", ctypes.c_void_p, [
	("m",		ctypes.POINTER(ctypes.POINTER(AVMetadata))),] )
...
guess_stream_format = _rpythonic_function_(		"guess_stream_format", ctypes.POINTER(AVOutputFormat), [
	("short_name",		ctypes.POINTER(ctypes.c_char)),
	("filename",		ctypes.POINTER(ctypes.c_char)),
	("mime_type",		ctypes.POINTER(ctypes.c_char)),] )

guess_format = _rpythonic_function_(		"guess_format", ctypes.POINTER(AVOutputFormat), [
	("short_name",		ctypes.POINTER(ctypes.c_char)),
	("filename",		ctypes.POINTER(ctypes.c_char)),
	("mime_type",		ctypes.POINTER(ctypes.c_char)),] )
...
av_alloc_format_context = _rpythonic_function_(		"av_alloc_format_context", ctypes.POINTER(AVFormatContext), [] )
...
ff_new_chapter = _rpythonic_function_(		"ff_new_chapter", ctypes.POINTER(AVChapter), [
	("s",		ctypes.POINTER(AVFormatContext)),
	("C_id",		ctypes.c_int),
	("time_base",		AVRational),
	("start",		ctypes.c_int64),
...
ff_reduce_index = _rpythonic_function_(		"ff_reduce_index", ctypes.c_void_p, [
	("s",		ctypes.POINTER(AVFormatContext)),
	("stream_index",		ctypes.c_int),] )
...
parse_image_size = _rpythonic_function_(		"parse_image_size", ctypes.c_int, [
	("width_ptr",		ctypes.POINTER(ctypes.c_int)),
	("height_ptr",		ctypes.POINTER(ctypes.c_int)),
	("C_str",		ctypes.POINTER(ctypes.c_char)),] )

parse_frame_rate = _rpythonic_function_(		"parse_frame_rate", ctypes.c_int, [
	("frame_rate",		ctypes.POINTER(ctypes.c_int)),
	("frame_rate_base",		ctypes.POINTER(ctypes.c_int)),
...
ffm_read_write_index = _rpythonic_function_(		"ffm_read_write_index", ctypes.c_int64, [
	("fd",		ctypes.c_int),] )

ffm_write_write_index = _rpythonic_function_(		"ffm_write_write_index", ctypes.c_int, [
	("fd",		ctypes.c_int),
	("pos",		ctypes.c_int64),] )

ffm_set_write_index = _rpythonic_function_(		"ffm_set_write_index", ctypes.c_void_p, [
	("s",		ctypes.POINTER(AVFormatContext)),
	("pos",		ctypes.c_int64),
	("file_size",		ctypes.c_int64),] )
