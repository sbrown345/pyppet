...
RPYTHONIC_GLOBAL_ENUMS = { 
 ...
 "mlt_audio_none" : 0,  "mlt_audio_pcm" : 1,  "mlt_audio_s16" : 1,  "mlt_audio_s32" : 2,  "mlt_audio_float" : 3,  "mlt_audio_s32le" : 4,  "mlt_audio_f32le" : 5, 
...
__freeze_rpythonic_struct( mlt_consumer_s, [
	...
	( "worker_threads", ctypes.POINTER(mlt_deque_s) ),
	( "done_mutex", pthread_mutex_t ),
	( "done_cond", pthread_cond_t ),
	( "consecutive_dropped", ctypes.c_int ),
	( "consecutive_rendered", ctypes.c_int ),
	( "process_head", ctypes.c_int ),
...
mlt_profile_list = _rpythonic_function_(		"mlt_profile_list", ctypes.POINTER(mlt_properties_s), [] )

mlt_profile_from_producer = _rpythonic_function_(		"mlt_profile_from_producer", ctypes.c_void_p, [
	("profile",		ctypes.POINTER(mlt_profile_s)),
	("producer",		ctypes.POINTER(mlt_producer_s)),] )
...
mlt_repository_presets = _rpythonic_function_(		"mlt_repository_presets", ctypes.POINTER(mlt_properties_s), [] )
...
mlt_properties_set_lcnumeric = _rpythonic_function_(		"mlt_properties_set_lcnumeric", ctypes.c_int, [
	("none",		ctypes.POINTER(ctypes.c_void_p)),
	("locale",		ctypes.POINTER(ctypes.c_char)),] )

mlt_properties_get_lcnumeric = _rpythonic_function_(		"mlt_properties_get_lcnumeric", ctypes.POINTER(ctypes.c_char), [
	("C_self",		ctypes.POINTER(mlt_properties_s)),] )

mlt_properties_load = _rpythonic_function_(		"mlt_properties_load", ctypes.POINTER(mlt_properties_s), [
	("file",		ctypes.POINTER(ctypes.c_char)),] )

mlt_properties_preset = _rpythonic_function_(		"mlt_properties_preset", ctypes.c_int, [
	("C_self",		ctypes.POINTER(mlt_properties_s)),
	("name",		ctypes.POINTER(ctypes.c_char)),] )
...
mlt_properties_lock = _rpythonic_function_(		"mlt_properties_lock", ctypes.c_void_p, [
	("C_self",		ctypes.POINTER(mlt_properties_s)),] )

mlt_properties_unlock = _rpythonic_function_(		"mlt_properties_unlock", ctypes.c_void_p, [
	("C_self",		ctypes.POINTER(mlt_properties_s)),] )

mlt_deque_compare = _rpythonic_function_(		"mlt_deque_compare", ctypes.c_int, [
...
mlt_deque_peek = _rpythonic_function_(		"mlt_deque_peek", ctypes.POINTER(ctypes.c_void_p), [
	("C_self",		ctypes.POINTER(mlt_deque_s)),
	("index",		ctypes.c_int),] )

mlt_deque_insert = _rpythonic_function_(		"mlt_deque_insert", ctypes.c_int, [
	("C_self",		ctypes.POINTER(mlt_deque_s)),
	("item",		ctypes.POINTER(ctypes.c_void_p)),
...
mlt_frame_set_image = _rpythonic_function_(		"mlt_frame_set_image", ctypes.c_int, [
	("C_self",		ctypes.POINTER(mlt_frame_s)),
	("image",		ctypes.POINTER(ctypes.c_uint8)),
	("size",		ctypes.c_int),
	("destroy",		ctypes.CFUNCTYPE(ctypes.c_void_p, )),] )

mlt_frame_set_alpha = _rpythonic_function_(		"mlt_frame_set_alpha", ctypes.c_int, [
	("C_self",		ctypes.POINTER(mlt_frame_s)),
	("alpha",		ctypes.POINTER(ctypes.c_uint8)),
	("size",		ctypes.c_int),
	("destroy",		ctypes.CFUNCTYPE(ctypes.c_void_p, )),] )
...
mlt_frame_unique_properties = _rpythonic_function_(		"mlt_frame_unique_properties", ctypes.POINTER(mlt_properties_s), [
	("C_self",		ctypes.POINTER(mlt_frame_s)),
	("service",		ctypes.POINTER(mlt_service_s)),] )
...
mlt_image_format_size = _rpythonic_function_(		"mlt_image_format_size", ctypes.c_int, [
	("format",		ctypes.c_int),
	("width",		ctypes.c_int),
	("height",		ctypes.c_int),
...
mlt_audio_format_size = _rpythonic_function_(		"mlt_audio_format_size", ctypes.c_int, [
	("format",		ctypes.c_int),
...
mlt_filter_get_length = _rpythonic_function_(		"mlt_filter_get_length", ctypes.c_int32, [
	("C_self",		ctypes.POINTER(mlt_filter_s)),] )

mlt_filter_get_position = _rpythonic_function_(		"mlt_filter_get_position", ctypes.c_int32, [
	("C_self",		ctypes.POINTER(mlt_filter_s)),
	("frame",		ctypes.POINTER(mlt_frame_s)),] )

mlt_filter_get_progress = _rpythonic_function_(		"mlt_filter_get_progress", ctypes.c_double, [
	("C_self",		ctypes.POINTER(mlt_filter_s)),
	("frame",		ctypes.POINTER(mlt_frame_s)),] )
...
mlt_transition_get_length = _rpythonic_function_(		"mlt_transition_get_length", ctypes.c_int32, [
	("C_self",		ctypes.POINTER(mlt_transition_s)),] )

mlt_transition_get_position = _rpythonic_function_(		"mlt_transition_get_position", ctypes.c_int32, [
	("C_self",		ctypes.POINTER(mlt_transition_s)),
	("frame",		ctypes.POINTER(mlt_frame_s)),] )

mlt_transition_get_progress = _rpythonic_function_(		"mlt_transition_get_progress", ctypes.c_double, [
	("C_self",		ctypes.POINTER(mlt_transition_s)),
	("frame",		ctypes.POINTER(mlt_frame_s)),] )

mlt_transition_get_progress_delta = _rpythonic_function_(		"mlt_transition_get_progress_delta", ctypes.c_double, [
	("C_self",		ctypes.POINTER(mlt_transition_s)),
	("frame",		ctypes.POINTER(mlt_frame_s)),] )
...
mlt_tokeniser_parse_new = _rpythonic_function_(		"mlt_tokeniser_parse_new", ctypes.c_int, [
	("tokeniser",		ctypes.POINTER(mlt_tokeniser)),
