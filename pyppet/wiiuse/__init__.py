...
EXP_WII_BOARD = 4
EXP_MOTION_PLUS = 5
EXP_MOTION_PLUS_NUNCHUK = 6
EXP_MOTION_PLUS_CLASSIC = 7
MAX_PAYLOAD = 32
## enums ##
SCM_RIGHTS = 1 
...
WIIUSE_EVENT_TYPE = { 
	...
	"WIIUSE_READ_DATA" : 6, 
	"WIIUSE_WRITE_DATA" : 7, 
	"WIIUSE_NUNCHUK_INSERTED" : 8, 
	"WIIUSE_NUNCHUK_REMOVED" : 9, 
	"WIIUSE_CLASSIC_CTRL_INSERTED" : 10, 
	"WIIUSE_CLASSIC_CTRL_REMOVED" : 11, 
	"WIIUSE_GUITAR_HERO_3_CTRL_INSERTED" : 12, 
	"WIIUSE_GUITAR_HERO_3_CTRL_REMOVED" : 13, 
	"WIIUSE_WII_BOARD_CTRL_INSERTED" : 14, 
	"WIIUSE_WII_BOARD_CTRL_REMOVED" : 15, 
	"WIIUSE_MOTION_PLUS_ACTIVATED" : 16, 
	"WIIUSE_MOTION_PLUS_REMOVED" : 17, 
}
...
class ang3s_t(_rpythonic_struct_): pass
class ang3f_t(_rpythonic_struct_): pass
...
class motion_plus_t(_rpythonic_struct_): pass
...
class wiimote_callback_data_t(_rpythonic_struct_): pass
class data_req_t(_rpythonic_struct_): _array_wrapper_ = True
...
__freeze_rpythonic_struct( __pthread_mutex_s, [
	...
	#opaque-warning# <rpythonic.rpythonic.SomeThing object at 0xacc97ec>
])
...
__freeze_rpythonic_struct( ang3s_t, [
	( "roll", ctypes.c_int16 ),
	( "pitch", ctypes.c_int16 ),
	( "yaw", ctypes.c_int16 ),
])

__freeze_rpythonic_struct( ang3f_t, [
	( "roll", ctypes.c_float ),
...
__freeze_rpythonic_struct( motion_plus_t, [
	( "ext", ctypes.c_ubyte ),
	( "raw_gyro", ang3s_t ),
	( "cal_gyro", ang3s_t ),
	( "angle_rate_gyro", ang3f_t ),
	( "orient", orient_t ),
	( "acc_mode", ctypes.c_ubyte ),
	( "raw_gyro_threshold", ctypes.c_int ),
	( "nc", ctypes.POINTER(nunchuk_t) ),
	( "classic", ctypes.POINTER(classic_ctrl_t) ),
])
...
__freeze_rpythonic_struct( expansion_t, [
	( "C_type", ctypes.c_int ),
	( "mp", motion_plus_t ),
	#opaque-warning# <rpythonic.rpythonic.SomeThing object at 0xda79f0c>
])
...
__freeze_rpythonic_struct( data_req_t, [
	( "data", ( ctypes.c_ubyte * 21 ) ),
	( "C_len", ctypes.c_ubyte ),
	( "addr", ctypes.c_uint ),
	( "state", ctypes.c_int ),
	( "cb", ctypes.CFUNCTYPE(ctypes.c_void_p, ctypes.POINTER(wiimote_t),ctypes.POINTER(ctypes.c_ubyte),ctypes.c_ushort,) ),
	( "next", ctypes.POINTER(data_req_t) ),
])
...
__freeze_rpythonic_struct( wiimote_t, [
	...
	( "expansion_state", ctypes.c_ubyte ),
	( "data_req", ctypes.POINTER(data_req_t) ),
	...
	( "motion_plus_id", ( ctypes.c_ubyte * 6 ) ),
])

__freeze_rpythonic_struct( wiimote_callback_data_t, [
	( "uid", ctypes.c_int ),
	( "leds", ctypes.c_ubyte ),
	( "battery_level", ctypes.c_float ),
	( "accel", vec3b_t ),
...
wiiuse_set_motion_plus = _rpythonic_function_(		"wiiuse_set_motion_plus", ctypes.c_void_p, [
	("wm",		ctypes.POINTER(wiimote_t)),
	("status",		ctypes.c_int),] )
...
wiiuse_update = _rpythonic_function_(		"wiiuse_update", ctypes.c_int, [
	("wm",		ctypes.POINTER(ctypes.POINTER(wiimote_t))),
	("wiimotes",		ctypes.c_int),
	("callback",		ctypes.CFUNCTYPE(ctypes.c_void_p, ctypes.POINTER(wiimote_callback_data_t),)),] )
...
wiiuse_update_cb = _rpythonic_function_(		"wiiuse_update_cb", ctypes.c_void_p, [
	("wm",		ctypes.POINTER(wiimote_callback_data_t)),] )

wiiuse_write_cb = _rpythonic_function_(		"wiiuse_write_cb", ctypes.c_void_p, [
	("wm",		ctypes.POINTER(wiimote_t)),
	("data",		ctypes.POINTER(ctypes.c_ubyte)),
	("C_len",		ctypes.c_ushort),] )
...
_rpythonic_strip_prefixes_(['wiiuse_'])