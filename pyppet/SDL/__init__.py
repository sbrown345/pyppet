...
__freeze_rpythonic_struct( __wait_terminated, [
	...
	#opaque-warning# <rpythonic.rpythonic.SomeThing object at 0x28364d0>
])

__freeze_rpythonic_struct( __wait_stopped, [
	( "__w_stopval", ctypes.c_uint ),
	( "__w_stopsig", ctypes.c_uint ),
	#opaque-warning# <rpythonic.rpythonic.SomeThing object at 0x28367d0>
])
...
SDL_revcpy = _rpythonic_function_(		"SDL_revcpy", ctypes.POINTER(ctypes.c_void_p), [
	("dst",		ctypes.POINTER(ctypes.c_void_p)),
	("src",		ctypes.POINTER(ctypes.c_void_p)),
	("C_len",		ctypes.c_uint64),] )

SDL_strlcpy = _rpythonic_function_(		"SDL_strlcpy", ctypes.c_uint64, [
	("dst",		ctypes.POINTER(ctypes.c_char)),
	("src",		ctypes.POINTER(ctypes.c_char)),
	("maxlen",		ctypes.c_uint64),] )

SDL_strlcat = _rpythonic_function_(		"SDL_strlcat", ctypes.c_uint64, [
	("dst",		ctypes.POINTER(ctypes.c_char)),
	("src",		ctypes.POINTER(ctypes.c_char)),
	("maxlen",		ctypes.c_uint64),] )
...
SDL_iconv = _rpythonic_function_(		"SDL_iconv", ctypes.c_uint64, [
	("cd",		ctypes.POINTER(ctypes.c_void_p)),
	("inbuf",		ctypes.POINTER(ctypes.POINTER(ctypes.c_char))),
	("inbytesleft",		ctypes.POINTER(ctypes.c_uint64)),
	("outbuf",		ctypes.POINTER(ctypes.POINTER(ctypes.c_char))),
	("outbytesleft",		ctypes.POINTER(ctypes.c_uint64)),] )
