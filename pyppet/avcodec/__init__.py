...
CODEC_FLAG2_INTRA_REFRESH = 2097152
...
CODEC_CAP_CHANNEL_CONF = 1024
CODEC_CAP_NEG_LINESIZES = 2048
CODEC_CAP_FRAME_THREADS = 4096
CODEC_CAP_SLICE_THREADS = 8192
MB_TYPE_INTRA4x4 = 1
...
__freeze_rpythonic_struct( __wait_terminated, [
	...
	#opaque-warning# <rpythonic.rpythonic.SomeThing object at 0x375cb50>
])

__freeze_rpythonic_struct( __wait_stopped, [
	( "__w_stopval", ctypes.c_uint ),
	( "__w_stopsig", ctypes.c_uint ),
	#opaque-warning# <rpythonic.rpythonic.SomeThing object at 0x375ce50>
])
