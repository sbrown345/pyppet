## generated by RPythonic 0.4.8j	| host: 32bits
...
def _rpythonic_clean_up_missing_functions_():
	G = globals()
	for f in RPYTHONIC_WRAPPER_FUNCTIONS_FAILURES: G.pop( f )
...
__freeze_rpythonic_struct( __wait_terminated, [
	...
	#opaque-warning# <rpythonic.rpythonic.SomeThing object at 0xa5da4ec>
])

__freeze_rpythonic_struct( __wait_stopped, [
	( "__w_stopval", ctypes.c_uint ),
	( "__w_stopsig", ctypes.c_uint ),
	#opaque-warning# <rpythonic.rpythonic.SomeThing object at 0xa5da68c>
])
...
__freeze_rpythonic_struct( __pthread_mutex_s, [
	...
	#opaque-warning# <rpythonic.rpythonic.SomeThing object at 0xa5f31ec>
])
